...
// https://leetcode.com/contest/weekly-contest-332/problems/subsequence-with-the-minimum-score/
...
Input: s = "cde", t = "xyz"
Output: 3
Explanation: In this example, we remove characters "x", "y" and "z" at indices 0, 1, and 2
(0-indexed).
