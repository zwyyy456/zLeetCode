# [2171. Removing Minimum Number of Magic Beans][link] (Medium)
...
magic beans found in a particular magic bag.
...
We removed a total of 1 + 2 + 1 = 4 beans to make the remaining non-empty bags have an equal number
of beans.
...
We removed a total of 2 + 2 + 3 = 7 beans to make the remaining non-empty bags have an equal number
of beans.
